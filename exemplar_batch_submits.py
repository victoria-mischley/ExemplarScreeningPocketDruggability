...
file_list_path = "/expanse/lustre/projects/was136/vmischley/vmischley_04_28/Exemplar_Screen_01_17/exemplars/exemplar_commandlist_11_17_23.txt"
...
#SBATCH --job-name="exemplar_generation"
...
chunks = list(chunk_list(file_paths, 40))

# Create a job file for each chunk
for i, chunk in enumerate(chunks):
    # Define job file name
    job_file_name = f"exemplar_generation_{i + 1}.sb"
