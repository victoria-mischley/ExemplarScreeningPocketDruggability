...
def gen_exemplars(folder_path, num_chains_protein_B, interface_cutoff):
    output_file_path = "/Users/mischlv/Downloads/exemplar_commandlist_2.txt"
    ...
    for file in folder_path_path.iterdir():
        if file.is_file():
            ...
            if pdb_count == 2:
                ...
                exemplar_file_name_short = exemplar_file_name[:-4]
                complex_file_path = f"{folder_path_path}/complexes/{exemplar_file_name_short}_Complex.pdb"
