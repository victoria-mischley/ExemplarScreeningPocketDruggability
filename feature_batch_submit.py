...
file_list_path = "/expanse/lustre/projects/was136/vmischley/vmischley_04_28/Exemplar_Screen_01_17/exemplars/complexes/command_list_features.txt "
...
#SBATCH --job-name="pocket_druggability"
...
chunks = list(chunk_list(file_paths, 20))

# Create a job file for each chunk
for i, chunk in enumerate(chunks):
    # Define job file name
    job_file_name = f"pocket_druggability_jobs_{i + 1}.sb"
