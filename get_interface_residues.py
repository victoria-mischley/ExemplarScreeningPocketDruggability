...
def get_exemplar_command(file_path, num_chains_protein_B, interface_cutoff):
    print(file_path)
    # output_file_path = "/Users/mischlv/Downloads/exemplar_commandlist.txt"
    ...
    for ind in res_pairs_df.index:
        ...
        command = f"/expanse/lustre/projects/use300/jpg/rosetta.source.release-362/main/source/bin/make_exemplar.linuxgccrelease -database  /expanse/lustre/projects/use300/jpg/rosetta.source.release-362/main/database -s /expanse/lustre/projects/was136/vmischley/vmischley_04_28/Exemplar_Screen/Input_PDBs/{file_name} -pocket_num_angles 100 -pocket_psp -pocket_grid_size 10 -pocket_max_spacing 12 -central_relax_pdb_num {chainAres}:A,{chainBres}:B -pocket_filter_by_exemplar -pocket_static_grid -pocket_limit_exemplar_color -pocket_dump_exemplars -min_atoms 1 -max_atoms 65"
